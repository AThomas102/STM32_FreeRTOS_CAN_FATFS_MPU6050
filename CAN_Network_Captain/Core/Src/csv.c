...
/*
* Modified: https://github.com/winobes/libcsv
*/
 ...
 * field provided.
 *
 * Note that consecutive field delimiters indicate empty
 * cells and lines ending with a delimiter (before the
 * new line character) are interpreted as having a trailing
 * empty cell.
 *
 * Text-delimited cells may contain text delimiter, field
 * delimiter, and newline characters. Characters between the
 * end of a text delimiter and the field delimiter (or
